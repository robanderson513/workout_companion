...
namespace WorkoutAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Workout API", Version = "v1" });
            });
            ...
            //string connectionString = Configuration.GetConnectionString("WorkoutDB");
            string connectionString = Configuration.GetConnectionString("WorkoutDBAzure");
